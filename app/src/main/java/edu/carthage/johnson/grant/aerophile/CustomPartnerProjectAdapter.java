...
public class CustomPartnerProjectAdapter extends ArrayAdapter<PartnerProject> {

    private Context mContext;
    private String UserId;
    public CustomPartnerProjectAdapter(Context context, ArrayList<PartnerProject> projects, Context ctx){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        final PartnerProject project = getItem(position);
        ...
        convertView.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent (getContext(),PartnerBrowser.class);
                intent.putExtra("PartnerProject", (Parcelable) project);
